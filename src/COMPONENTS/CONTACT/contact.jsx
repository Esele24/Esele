...
export function Contact({}) {
  const [state, handleSubmit] = useForm("xwprpeql"); // Replace with your actual Formspree form ID

  if (state.succeeded) {
    return (
      <section className={styles.contact}>
        <h2 className={styles.success}>✅ Message sent successfully! We'll get back to you soon.</h2>
      </section>
    );
  }
            ...
            <form className={styles.form} onSubmit={handleSubmit}>
              <div className={styles.display}>
                <div className={styles.name}>
                  ...
                  <input id="firstName" name="firstName" className={styles.input} type="text" placeholder="  Your first name" required />
                </div>

                <div className={styles.name}>
                  <label htmlFor="lastName">Last Name</label>
                  <input id="lastName" name="lastName" className={styles.input} type="text" placeholder="  Your last name" required />
                </div>
              </div>
              ...
              <button className={styles.namesss} type="submit" disabled={state.submitting}>
            ...
            <div className={styles.itemsss}>
              ...
              <div className={styles.div}>
                ...
                <div className={styles.isa}>
                  ...
                  <Link className={styles.link} href="https://open.spotify.com/show/0voZtfepu40d36nLjYK6nT?si=52067f57fc1642d7np">Spotify</Link>
                </div>
              </div>
